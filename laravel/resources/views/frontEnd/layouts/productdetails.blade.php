...
<div class="span9">
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="{{$products->product_name}}S2950 Digital Camera">
				<img src="{{asset('uploads/'.@$products->image)}}" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			...
			<div class="span6">
				<h3>{{@$products->productDetails->title}}  </h3>
				<small>- (14MP, 18x Optical Zoom) 3-inch LCD</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>₹{{$products->product_price}}</span></label>
					<div class="controls">
				...
				<hr class="soft"/>
				<h4>{{@$products->productDetails->total_items}} items in stock</h4>
      ...
      @foreach($releted_products as $releted_product)
					<li class="span3">
					  <div class="thumbnail">
						...
						<div class="caption">
						  <h5>{{$releted_product->product_name}}</h5>
						
						  <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">&euro;{{$releted_product->product_price}}</a></h4>
						</div>
					  </div>
					</li>
      @endforeach
