<div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-list-alt"></i> Category Manager <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('catagory.list')}}">Category List</a></li>
                      <li><a href="{{route('catagory.add')}}">Create Category</a></li>
                    </ul>
                  </li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="{{route('adminbackend.logout')}}">
